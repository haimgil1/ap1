...
public:
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
    * function name: acceptDescriptorCommunicate.	`					   *
    * The Input: none										               *
    * The output: int number representing the connection between server    *
    * and client.                                                          *
    * The Function operation: Create a connction between server and client *
    ***********************************************************************/
